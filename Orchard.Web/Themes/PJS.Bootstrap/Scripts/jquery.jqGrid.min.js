...
b,c;"columns"===$(this).attr("value")&&(b=$(this).parent().width()+18,c=-15,da(c,b,$(this).parent())),"filtering"===$(this).attr("value")&&(b=$(this).parent().width()+18,c=-15,ea(a,c,b,$(this).parent())),$(this).addClass(p)},function(){$(this).removeClass(p)}).click(function(){var
