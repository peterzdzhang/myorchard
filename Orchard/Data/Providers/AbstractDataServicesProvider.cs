...
#if DEBUG
            string mappingsPath = System.IO.Path.Combine(parameters.DataFolder, "Mappings");
            if (!System.IO.Directory.Exists(mappingsPath))
            {
                System.IO.Directory.CreateDirectory(mappingsPath);
            }
